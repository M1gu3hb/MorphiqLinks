...
1. Importa `M1gu3hb/MorphiqLinks` como proyecto Vercel llamado `morphiq-links`. Framework: **Other**. El directorio público es `public`.
...
3. Vuelve a desplegar tras configurar las variables.
